...
public interface ITypeConvertHandler {
     ...
     * @return 子类类型
     */
    IColumnType convert(TableField.MetaInfo metaInfo);

    
    class DefaultTypeConvertHandler implements ITypeConvertHandler {
        private final DateType dateType;

        private final Map<Integer, IColumnType> typeMap = new HashMap<>();

        public DefaultTypeConvertHandler(DateType dateType) {
        ...
        @Override
        public IColumnType convert(TableField.MetaInfo metaInfo) {
