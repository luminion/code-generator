 ...
 * @since 1.0.0
 */
public abstract class GlobalConfigBase<C extends Switchable<C>> extends AbstractSwitchableConfig<C> {

    public GlobalConfigBase(ConfigSwitcher<C> configSwitcher) {
