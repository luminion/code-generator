...
public class Resolver {
    ...
    public boolean isGenerate(TemplateFileEnum templateFileEnum, TableInfo tableInfo) {
        TemplateFile templateFile = this.configurer.getTemplateFileMap().get(templateFileEnum.getKey());
    ...
    public List<TemplateFile> getTemplateFiles() {
        ...
        return this.configurer.getTemplateFileMap().values()
    ...
    public Map<String, Boolean> getOutputClassGenerateMap() {
        return this.configurer.getTemplateFileMap().entrySet().stream()
