...
public enum RuntimeClass {
    ...
    JAVA_NIO_STANDARD_CHARSETS("java.nio.charset.StandardCharsets"),
    JAVA_TIME_LOCAL_DATE_TIME("java.time.LocalDateTime"),
    JAVA_TIME_FORMAT_DATE_TIME_FORMATTER("java.time.format.DateTimeFormatter"),
    ...
    MYBATIS_PLUS_ACTIVE_RECORD_MODEL("com.baomidou.mybatisplus.extension.activerecord.Model"),
    ...
    MYBATIS_PLUS_FIELD_FILL("com.baomidou.mybatisplus.annotation.FieldFill"),
