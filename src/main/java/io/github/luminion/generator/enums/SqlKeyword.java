...
public enum SqlKeyword {
    ...
    // ==================== 位运算 (XML特有) ====================
    HAS_ANY_BITS("HAS ANY BITS", "HAS ANY BITS", "HAS_ANY_BITS", "HAS ANY BITS", "BIT_ANY"),
    HAS_ALL_BITS("HAS ALL BITS", "HAS ALL BITS", "HAS_ALL_BITS", "HAS ALL BITS", "BIT_ALL"),
    HAS_NO_BITS("HAS NO BITS", "HAS NO BITS", "HAS_NO_BITS", "HAS NO BITS", "BIT_NONE");
